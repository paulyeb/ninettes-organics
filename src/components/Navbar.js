...
const Navbar = () => {
    return (
        <div className="py-8 font-poppins w-full fixed top-0 bg-white">
            <div className="container flex justify-between items-center">
                {/* <div>
                    Name
                </div> */}
                <div className="flex items-center">
                    <img src="images/logo.png" alt="Lekem's organics" className="object-cover w-20 h-20" />
                    <legend className="lg:text-5xl text-4xl font-medium mx-2">Lekem's Organics</legend>
                </div>
                <div className="">
